class ArtifactMissionPyromancer extends ArtifactMission
		config(UT2004RPG);
...
function Activate()
{
	...
	if ((Instigator != None) && (Instigator.Controller != None))
	{
		if ((Instigator != None) && (Instigator.Controller != None))
		{
			...
			if (M1Inv.PyromancerActive || M2Inv.PyromancerActive || M3Inv.PyromancerActive)
			{
...
defaultproperties
{
     ...
     PickupClass=Class'DEKRPG208.ArtifactMissionPyromancerPickup'
     IconMaterial=Texture'MissionsTex4.MagicWeaponMissions.PyromancerMission'
     ItemName="Pyromancer"
}
