...
simulated event touch (Actor Other)
{
	...
	if (Proj != None && Proj.InstigatorController.SameTeamAs(PC))
		return; //let team projectiles pass, but not enemy
...
defaultproperties
{
     ...
     MinGap=80
     Height=120
     DefaultController=Class'DEKRPG208.DruidEnergyWallController'
     DefaultPost=Class'DEKRPG208.DruidEnergyWallPost'
     MinDamage=5
     MaxDamage=60
