class MissionBalloonOrange extends MissionBalloon;
...
function TakeDamage(int Damage, Pawn instigatedBy, Vector hitlocation, Vector momentum, class<DamageType> damageType)
{
	...
	A = spawn(class'MissionBalloonOrangePopEffect',,, Self.Location + vect(0,0,55));
	if (A != None)
	{
...
defaultproperties
{
	Skins(0)=Texture'MissionsTex4.Colors.Orange'
}
