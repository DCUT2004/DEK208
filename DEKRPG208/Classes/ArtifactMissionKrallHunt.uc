class ArtifactMissionKrallHunt extends ArtifactMission
		config(UT2004RPG);
...
function Activate()
{
	...
	if ((Instigator != None) && (Instigator.Controller != None))
	{
		if ((Instigator != None) && (Instigator.Controller != None))
		{
			...
			if (M1Inv.KrallHuntActive || M2Inv.KrallHuntActive || M3Inv.KrallHuntActive)
			{
...
defaultproperties
{
     ...
     PickupClass=Class'DEKRPG208.ArtifactMissionKrallHuntPickup'
     IconMaterial=Texture'MissionsTex4.HuntMissions.KrallHuntMission'
     ItemName="Krall Hunt"
}
