class ArtifactMissionSpiderman extends ArtifactMission
		config(UT2004RPG);
...
function Activate()
{
	...
	if ((Instigator != None) && (Instigator.Controller != None))
	{
		if ((Instigator != None) && (Instigator.Controller != None))
		{
			...
			if (M1Inv.SpidermanActive || M2Inv.SpidermanActive || M3Inv.SpidermanActive)
			{
...
static function string GetLocalString(optional int Switch, optional PlayerReplicationInfo RelatedPRI_1, optional PlayerReplicationInfo RelatedPRI_2)
{
	...
	if (Switch == 4000)
		...
		return "Make kills while using electro-magnet!";
}
...
defaultproperties
{
     ...
     PickupClass=Class'DEKRPG208.ArtifactMissionSpidermanPickup'
     IconMaterial=Texture'MissionsTex4.ArtifactMissions.SpidermanMission'
     ItemName="Spiderman"
}
