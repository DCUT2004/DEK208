class DruidBallWeapon extends Weapon_Turret;
...
defaultproperties
{
     FireModeClass(0)=Class'DEKRPG208.FM_DruidBallTurret_Fire'
     FireModeClass(1)=Class'DEKRPG208.FM_DruidBallTurret_AltFire'
}
