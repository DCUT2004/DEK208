class DEKAutoMercury extends ASTurret;
...
{
	DefaultWeaponClassName=string(class'DEKAutoMercuryWeapon');
...
{
	local DEKAutoMercuryController C;
	
	C = DEKAutoMercuryController(self.Controller);
