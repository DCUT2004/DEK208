class Weapon_DruidLink extends Weapon_Linkturret
    config(user)
    HideDropDown
	CacheExempt;

// add the RPGLinkGun stuff to the linkturret
...
defaultproperties
{
     FireModeClass(0)=Class'DEKRPG208.FM_DruidLink_Fire'
     FireModeClass(1)=Class'DEKRPG208.FM_DruidLink_AltFire'
}
