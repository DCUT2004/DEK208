class ArtifactMissionBoneCrusher extends ArtifactMission
		config(UT2004RPG);
...
function Activate()
{
	...
	if ((Instigator != None) && (Instigator.Controller != None))
	{
		if ((Instigator != None) && (Instigator.Controller != None))
		{
			...
			if (M1Inv.BoneCrusherActive || M2Inv.BoneCrusherActive || M3Inv.BoneCrusherActive)
			{
...
static function string GetLocalString(optional int Switch, optional PlayerReplicationInfo RelatedPRI_1, optional PlayerReplicationInfo RelatedPRI_2)
{
	...
	if (Switch == 4000)
		...
		return "Kill skeletons and skulls.";
}
...
defaultproperties
{
     ...
     PickupClass=Class'DEKRPG208.ArtifactMissionBoneCrusherPickup'
     IconMaterial=Texture'MissionsTex4.HuntMissions.BoneCrusherMission'
