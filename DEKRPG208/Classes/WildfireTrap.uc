class WildfireTrap extends Weapon
	config(DEKWeapons);

#exec OBJ LOAD FILE=HudContent.utx

var array<WildfireTrapProjectile> Mines;
...
defaultproperties
{
     ...
     FireModeClass(0)=Class'DEKRPG208.WildfireTrapFire'
     FireModeClass(1)=Class'DEKRPG208.WildfireTrapAltFire'
     PutDownAnim="PutDown"
     ...
     bCanThrow=False
     Description="The Wildfire Trap automatically detones when an enemy target comes into contact."
     ...
     GroupOffset=1
     PickupClass=Class'DEKRPG208.WildfireTrapPickup'
