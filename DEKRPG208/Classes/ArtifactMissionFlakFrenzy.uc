class ArtifactMissionFlakFrenzy extends ArtifactMission
		config(UT2004RPG);
...
function Activate()
{
	...
	if ((Instigator != None) && (Instigator.Controller != None))
	{
		if ((Instigator != None) && (Instigator.Controller != None))
		{
			...
			if (M1Inv.FlakFrenzyActive || M2Inv.FlakFrenzyActive || M3Inv.FlakFrenzyActive)
			{
...
defaultproperties
{
     ...
     PickupClass=Class'DEKRPG208.ArtifactMissionFlakFrenzyPickup'
     IconMaterial=Texture'MissionsTex4.WeaponMissions.MissionFlakCannon'
