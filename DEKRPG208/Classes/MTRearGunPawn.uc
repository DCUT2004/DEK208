...
//
//-----------------------------------------------------------
class MTRearGunPawn extends ONSWeaponPawn;

defaultproperties
{
     GunClass=Class'DEKRPG208.MTRearGun'
     ...
     VehiclePositionString="in a Super Beast Rear Turret"
     VehicleNameString="Super Beast Rear Turret"
     AmbientGlow=2
     bShadowCast=True
}
