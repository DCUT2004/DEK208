class ArtifactMissionDeflector extends ArtifactMission
		config(UT2004RPG);
...
function Activate()
{
	...
	if ((Instigator != None) && (Instigator.Controller != None))
	{
		if ((Instigator != None) && (Instigator.Controller != None))
		{
			...
			if (M1Inv.DeflectorActive || M2Inv.DeflectorActive || M3Inv.DeflectorActive)
			{
...
static function string GetLocalString(optional int Switch, optional PlayerReplicationInfo RelatedPRI_1, optional PlayerReplicationInfo RelatedPRI_2)
{
	...
	if (Switch == 4000)
		...
		return "Use a reflecting weapon to deflect projectiles!";
}
...
defaultproperties
{
     ...
     PickupClass=Class'DEKRPG208.ArtifactMissionDeflectorPickup'
     IconMaterial=Texture'MissionsTex4.MagicWeaponMissions.DeflectorMission'
     ItemName="Deflector"
}
