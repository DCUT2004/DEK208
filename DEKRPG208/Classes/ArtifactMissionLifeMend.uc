class ArtifactMissionLifeMend extends ArtifactMission
		config(UT2004RPG);
...
function Activate()
{
	...
	if ((Instigator != None) && (Instigator.Controller != None))
	{
		if ((Instigator != None) && (Instigator.Controller != None))
		{
			...
			if (M1Inv.LifeMendActive || M2Inv.LifeMendActive || M3Inv.LifeMendActive)
			{
...
static function string GetLocalString(optional int Switch, optional PlayerReplicationInfo RelatedPRI_1, optional PlayerReplicationInfo RelatedPRI_2)
{
	...
	if (Switch == 4000)
		...
		return "Heal your teammates with a healing weapon!";
}
...
defaultproperties
{
     ...
     PickupClass=Class'DEKRPG208.ArtifactMissionLifeMendPickup'
     IconMaterial=Texture'MissionsTex4.MiscellaneousMissions.LifeMendMission'
     ItemName="Life Mend"
}
