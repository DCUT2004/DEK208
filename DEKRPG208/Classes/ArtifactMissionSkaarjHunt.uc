class ArtifactMissionSkaarjHunt extends ArtifactMission
		config(UT2004RPG);
...
function Activate()
{
	...
	if ((Instigator != None) && (Instigator.Controller != None))
	{
		if ((Instigator != None) && (Instigator.Controller != None))
		{
			...
			if (M1Inv.SkaarjHuntActive || M2Inv.SkaarjHuntActive || M3Inv.SkaarjHuntActive)
			{
...
static function string GetLocalString(optional int Switch, optional PlayerReplicationInfo RelatedPRI_1, optional PlayerReplicationInfo RelatedPRI_2)
{
	...
	if (Switch == 4000)
		...
		return "Kill Skaarj, Troopers, or Snipers.";
}
...
defaultproperties
{
     ...
     PickupClass=Class'DEKRPG208.ArtifactMissionSkaarjHuntPickup'
     IconMaterial=Texture'MissionsTex4.HuntMissions.SkaarjHuntMission'
