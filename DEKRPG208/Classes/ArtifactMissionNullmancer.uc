class ArtifactMissionNullmancer extends ArtifactMission
		config(UT2004RPG);
...
function Activate()
{
	...
	if ((Instigator != None) && (Instigator.Controller != None))
	{
		if ((Instigator != None) && (Instigator.Controller != None))
		{
			...
			if (M1Inv.NullmancerActive || M2Inv.NullmancerActive || M3Inv.NullmancerActive)
			{
...
static function string GetLocalString(optional int Switch, optional PlayerReplicationInfo RelatedPRI_1, optional PlayerReplicationInfo RelatedPRI_2)
{
	...
	if (Switch == 4000)
		...
		return "Apply null entropy magic!";
}
...
defaultproperties
{
     ...
     PickupClass=Class'DEKRPG208.ArtifactMissionNullmancerPickup'
     IconMaterial=Texture'MissionsTex4.MagicWeaponMissions.NullmancerMission'
     ItemName="Nullmancer"
}
