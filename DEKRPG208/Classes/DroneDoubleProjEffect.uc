class DroneDoubleProjEffect extends Emitter;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter1
         ...
         ColorScale(0)=(Color=(B=197,G=44,R=232))
         ColorScale(1)=(RelativeTime=0.750000,Color=(B=197,G=44,R=232))
     ...
     End Object
     Emitters(0)=SpriteEmitter'DEKRPG208.DroneDoubleProjEffect.SpriteEmitter1'
     ...
     Begin Object Class=BeamEmitter Name=BeamEmitter1
         ...
         AutomaticInitialSpawning=False
         ColorScale(0)=(Color=(B=197,G=44,R=232))
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=197,G=44,R=232))
         CoordinateSystem=PTCS_Relative
         MaxParticles=1
     ...
     End Object
     Emitters(1)=BeamEmitter'DEKRPG208.DroneDoubleProjEffect.BeamEmitter1'
