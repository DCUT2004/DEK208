...
function bool ClassInfo(GUIComponent Sender)
{
	local class<RPGClass> Ability;

	Ability = class<RPGClass>(Classes.List.GetObject());
...
defaultproperties
{
     ...
     End Object
     Controls(0)=GUIButton'DEKRPG208.DruidsRPGBuyClassPage.QuitBackground'
     ...
     End Object
     Controls(1)=GUIButton'DEKRPG208.DruidsRPGBuyClassPage.ClassBuyButton'
     ...
     End Object
     Controls(2)=GUIButton'DEKRPG208.DruidsRPGBuyClassPage.CloseButton'
     ...
     End Object
     Controls(3)=GUIListBox'DEKRPG208.DruidsRPGBuyClassPage.ClassList'
     ...
     Begin Object Class=GUILabel Name=SelectText
         ...
         bScaleToParent=True
     End Object
     Controls(4)=GUILabel'DEKRPG208.DruidsRPGBuyClassPage.SelectText'
     ...
     Begin Object Class=GUIButton Name=ClassInfoButton
         ...
         OnKeyEvent=ClassBuyButton.InternalOnKeyEvent
     End Object
     Controls(5)=GUIButton'DEKRPG208.DruidsRPGBuyClassPage.ClassInfoButton'
