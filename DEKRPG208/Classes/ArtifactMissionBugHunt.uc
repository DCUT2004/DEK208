class ArtifactMissionBugHunt extends ArtifactMission
		config(UT2004RPG);
...
function Activate()
{
	...
	if ((Instigator != None) && (Instigator.Controller != None))
	{
		if ((Instigator != None) && (Instigator.Controller != None))
		{
			...
			if (M1Inv.BugHuntActive || M2Inv.BugHuntActive || M3Inv.BugHuntActive)
			{
...
static function string GetLocalString(optional int Switch, optional PlayerReplicationInfo RelatedPRI_1, optional PlayerReplicationInfo RelatedPRI_2)
{
	...
	if (Switch == 4000)
		...
		return "Kill pupae, razorfly, or mantas.";
}
...
defaultproperties
{
     ...
     PickupClass=Class'DEKRPG208.ArtifactMissionBugHuntPickup'
     IconMaterial=Texture'MissionsTex4.HuntMissions.BugHuntMission'
     ItemName="Bug Hunt"
}
