class ArtifactMissionNaniteCrash extends ArtifactMission
		config(UT2004RPG);
...
function Activate()
{
	...
	if ((Instigator != None) && (Instigator.Controller != None))
	{
		if ((Instigator != None) && (Instigator.Controller != None))
		{
			...
			if (M1Inv.NaniteCrashActive || M2Inv.NaniteCrashActive || M3Inv.NaniteCrashActive)
			{
...
defaultproperties
{
     ...
     PickupClass=Class'DEKRPG208.ArtifactMissionNaniteCrashPickup'
     IconMaterial=Texture'MissionsTex4.HuntMissions.NaniteCrashMission'
