class ArtifactMissionSharpShotFly extends ArtifactMission
		config(UT2004RPG);
...
function Activate()
{
	...
	if ((Instigator != None) && (Instigator.Controller != None))
	{
		if ((Instigator != None) && (Instigator.Controller != None))
		{
			...
			if (M1Inv.SharpShotFlyActive || M2Inv.SharpShotFlyActive || M3Inv.SharpShotFlyActive)
			{
...
static function string GetLocalString(optional int Switch, optional PlayerReplicationInfo RelatedPRI_1, optional PlayerReplicationInfo RelatedPRI_2)
{
	...
	if (Switch == 4000)
		...
		return "Kill vampire gnats with a sniper-type weapon!";
}
...
defaultproperties
{
     ...
     PickupClass=Class'DEKRPG208.ArtifactMissionSharpShotFlyPickup'
     IconMaterial=Texture'MissionsTex4.MiscellaneousMissions.SharpShotFlyMission'
