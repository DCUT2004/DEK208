class ArtifactMissionThundergod extends ArtifactMission
		config(UT2004RPG);
...
function Activate()
{
	...
	if ((Instigator != None) && (Instigator.Controller != None))
	{
		if ((Instigator != None) && (Instigator.Controller != None))
		{
			...
			if (M1Inv.ThunderGodActive || M2Inv.ThunderGodActive || M3Inv.ThunderGodActive)
			{
...
static function string GetLocalString(optional int Switch, optional PlayerReplicationInfo RelatedPRI_1, optional PlayerReplicationInfo RelatedPRI_2)
{
	...
	if (Switch == 4000)
		...
		return "Use the lightning rod combo and artifact simultaneously!";
}
...
defaultproperties
{
     ...
     PickupClass=Class'DEKRPG208.ArtifactMissionThundergodPickup'
     IconMaterial=Texture'MissionsTex4.ArtifactMissions.ThunderGodMission'
