class MissionBalloonGreen extends MissionBalloon;
...
function TakeDamage(int Damage, Pawn instigatedBy, Vector hitlocation, Vector momentum, class<DamageType> damageType)
{
	...
	A = spawn(class'MissionBalloonGreenPopEffect',,, Self.Location + vect(0,0,55));
	if (A != None)
	{
...
{
    AirSpeed=640.000000
	Skins(0)=Texture'MissionsTex4.Colors.LightGreen'
}
