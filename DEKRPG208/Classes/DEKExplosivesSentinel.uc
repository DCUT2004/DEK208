class DEKExplosivesSentinel extends ASTurret;
...
{
	local DEKExplosivesSentinelController C;
	
	C = DEKExplosivesSentinelController(self.Controller);
...
defaultproperties
{
     ...
     TurretBaseClass=Class'DEKRPG208.DEKExplosivesSentinelBase'
