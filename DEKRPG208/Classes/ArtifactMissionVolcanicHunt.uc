class ArtifactMissionVolcanicHunt extends ArtifactMission
		config(UT2004RPG);
...
function Activate()
{
	...
	if ((Instigator != None) && (Instigator.Controller != None))
	{
		if ((Instigator != None) && (Instigator.Controller != None))
		{
			...
			if (M1Inv.VolcanicHuntActive || M2Inv.VolcanicHuntActive || M3Inv.VolcanicHuntActive)
			{
...
defaultproperties
{
     ...
     PickupClass=Class'DEKRPG208.ArtifactMissionVolcanicHuntPickup'
     IconMaterial=Texture'MissionsTex4.HuntMissions.VolcanicHuntMission'
