class ArtifactMissionGhostBuster extends ArtifactMission
		config(UT2004RPG);
...
function Activate()
{
	...
	if ((Instigator != None) && (Instigator.Controller != None))
	{
		if ((Instigator != None) && (Instigator.Controller != None))
		{
			...
			if (M1Inv.GhostBusterActive || M2Inv.GhostBusterActive || M3Inv.GhostBusterActive)
			{
...
defaultproperties
{
     ...
     PickupClass=Class'DEKRPG208.ArtifactMissionGhostBusterPickup'
     IconMaterial=Texture'MissionsTex4.HuntMissions.GhostBusterMission'
