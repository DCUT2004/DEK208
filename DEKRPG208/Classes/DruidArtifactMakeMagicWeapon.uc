...
function Activate()
{
	...
	if (Instigator != None)
	{
		...
		if (RW_EngineerLink(Instigator.Weapon) != None || AerialTrap(Instigator.Weapon) != None || BombTrap(Instigator.Weapon) != None || FrostTrap(Instigator.Weapon) != None || ShockTrap(Instigator.Weapon) != None || WildfireTrap(Instigator.Weapon) != None || DEKLaserGrenadeLauncher(Instigator.Weapon) != None || NecromancerBloodWeapon(Instigator.Weapon) != None)
		{
...
defaultproperties
{
     ...
     PickupClass=Class'DEKRPG208.DruidArtifactMakeMagicWeaponPickup'
     IconMaterial=Shader'DEKRPGTexturesMaster207P.Artifacts.MagicWeaponMakerIconShader'
