class ArtifactMissionRocketRage extends ArtifactMission
		config(UT2004RPG);
...
function Activate()
{
	...
	if ((Instigator != None) && (Instigator.Controller != None))
	{
		if ((Instigator != None) && (Instigator.Controller != None))
		{
			...
			if (M1Inv.RocketRageActive || M2Inv.RocketRageActive || M3Inv.RocketRageActive)
			{
...
static function string GetLocalString(optional int Switch, optional PlayerReplicationInfo RelatedPRI_1, optional PlayerReplicationInfo RelatedPRI_2)
{
	...
	if (Switch == 4000)
		...
		return "Use the Rocket Launcher.";
}
...
defaultproperties
{
     ...
     PickupClass=Class'DEKRPG208.ArtifactMissionRocketRagePickup'
     IconMaterial=Texture'MissionsTex4.WeaponMissions.MissionRocketLauncher'
