class PoisonBlastExplosion extends Emitter
	placeable;
...
defaultproperties
{
     ...
     End Object
     Emitters(0)=SpriteEmitter'DEKRPG208.PoisonBlastExplosion.SpriteEmitter0'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter1
         ...
         AutomaticInitialSpawning=False
         UseVelocityScale=True
         ColorScale(1)=(RelativeTime=0.330000,Color=(B=128,G=158,R=128,A=190))
         ColorScale(2)=(RelativeTime=0.660000,Color=(B=182,G=212,R=182,A=190))
         ColorScale(3)=(RelativeTime=1.000000,Color=(B=128,G=158,R=128,A=190))
         FadeInEndTime=0.100000
         MaxParticles=30
         ...
         VelocityScale(3)=(RelativeTime=1.000000)
     End Object
     Emitters(1)=SpriteEmitter'DEKRPG208.PoisonBlastExplosion.SpriteEmitter1'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter2
         ...
         AutomaticInitialSpawning=False
         UseVelocityScale=True
         ColorScale(1)=(RelativeTime=0.330000,Color=(B=40,G=190,R=40,A=170))
         ColorScale(2)=(RelativeTime=0.660000,Color=(B=40,G=230,R=40,A=150))
         ColorScale(3)=(RelativeTime=1.000000,Color=(B=40,G=190,R=40,A=150))
         FadeInEndTime=0.100000
         MaxParticles=75
         StartLocationShape=PTLS_Sphere
     ...
     End Object
     Emitters(2)=SpriteEmitter'DEKRPG208.PoisonBlastExplosion.SpriteEmitter2'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter3
         ...
         AutomaticInitialSpawning=False
         UseVelocityScale=True
         ColorScale(1)=(RelativeTime=0.330000,Color=(B=40,G=180,R=40))
         ColorScale(2)=(RelativeTime=0.660000,Color=(B=55,G=255,R=55))
         ColorScale(3)=(RelativeTime=1.000000,Color=(B=50,G=190,R=50))
         FadeInEndTime=0.100000
         MaxParticles=25
         StartLocationShape=PTLS_Sphere
         SphereRadiusRange=(Min=64.000000,Max=128.000000)
         ...
         VelocityScale(3)=(RelativeTime=1.000000)
     End Object
     Emitters(3)=SpriteEmitter'DEKRPG208.PoisonBlastExplosion.SpriteEmitter3'
     ...
     Begin Object Class=MeshEmitter Name=MeshEmitter0
         ...
         ColorScale(2)=(RelativeTime=0.600000,Color=(B=26,G=146,R=226))
         ColorScale(3)=(RelativeTime=1.000000,Color=(B=27,G=197,R=27))
     ...
     End Object
     Emitters(4)=MeshEmitter'DEKRPG208.PoisonBlastExplosion.MeshEmitter0'
     ...
     Begin Object Class=MeshEmitter Name=MeshEmitter1
         ...
         UniformSize=True
         AutomaticInitialSpawning=False
         ColorScale(1)=(RelativeTime=0.300000,Color=(B=25,G=255,R=25,A=255))
         ColorScale(2)=(RelativeTime=0.600000,Color=(B=25,G=255,R=25,A=128))
         ColorScale(3)=(RelativeTime=1.000000,Color=(B=25,G=255,R=25,A=128))
         FadeOutStartTime=1.000000
         FadeInEndTime=0.100000
         MaxParticles=1
     ...
     End Object
     Emitters(5)=MeshEmitter'DEKRPG208.PoisonBlastExplosion.MeshEmitter1'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter4
         ...
         ColorScale(1)=(RelativeTime=0.600000,Color=(B=45,G=255,R=45))
         ColorScale(2)=(RelativeTime=0.800000,Color=(B=47,G=207,R=47))
         ColorScale(3)=(RelativeTime=1.000000,Color=(B=47,G=187,R=47))
         MaxParticles=1
         SizeScale(0)=(RelativeSize=0.200000)
     ...
     End Object
     Emitters(6)=SpriteEmitter'DEKRPG208.PoisonBlastExplosion.SpriteEmitter4'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter5
         ...
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=44,G=234,R=44))
         ...
         LifetimeRange=(Min=1.000000,Max=1.000000)
     End Object
     Emitters(7)=SpriteEmitter'DEKRPG208.PoisonBlastExplosion.SpriteEmitter5'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter6
         ...
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=34,G=234,R=34))
         ...
         GetVelocityDirectionFrom=PTVD_AddRadial
     End Object
     Emitters(8)=SpriteEmitter'DEKRPG208.PoisonBlastExplosion.SpriteEmitter6'
     ...
     Begin Object Class=MeshEmitter Name=MeshEmitter2
         ...
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=54,G=194,R=54,A=255))
     ...
     End Object
     Emitters(9)=MeshEmitter'DEKRPG208.PoisonBlastExplosion.MeshEmitter2'
