class ArtifactSummonSkaarj extends RPGArtifact
	config(UT2004RPG);
...
{		
	...
	M = MInv.SummonMonster(class'SkaarjPack.IceSkaarj', 30, 0);
...
defaultproperties
{
     ...
     PickupClass=Class'DEKRPG208.ArtifactSummonSkaarjPickup'
}
