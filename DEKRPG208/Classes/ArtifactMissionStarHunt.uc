class ArtifactMissionStarHunt extends ArtifactMission
		config(UT2004RPG);
...
function Activate()
{
	...
	if ((Instigator != None) && (Instigator.Controller != None))
	{
		if ((Instigator != None) && (Instigator.Controller != None))
		{
			...
			if (M1Inv.StarHuntActive || M2Inv.StarHuntActive || M3Inv.StarHuntActive)
			{
...
defaultproperties
{
     ...
     PickupClass=Class'DEKRPG208.ArtifactMissionStarHuntPickup'
     IconMaterial=Texture'MissionsTex4.HuntMissions.StarHuntMission'
     ItemName="Star Hunt"
}
