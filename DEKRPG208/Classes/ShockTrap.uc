class ShockTrap extends Weapon
	config(DEKWeapons);

#exec OBJ LOAD FILE=HudContent.utx

var array<ShockTrapProjectile> Mines;
...
defaultproperties
{
     ...
     FireModeClass(0)=Class'DEKRPG208.ShockTrapFire'
     FireModeClass(1)=Class'DEKRPG208.ShockTrapAltFire'
     PutDownAnim="PutDown"
     ...
     bCanThrow=False
     Description="The Shock Trap automatically detones when an enemy target comes into contact."
     EffectOffset=(X=30.000000,Y=10.000000,Z=-10.000000)
     DisplayFOV=60.000000
     Priority=10
     HudColor=(B=255,G=196,R=213)
     ...
     GroupOffset=1
     PickupClass=Class'DEKRPG208.ShockTrapPickup'
