class ArtifactMissionGlacialHunt extends ArtifactMission
		config(UT2004RPG);
...
function Activate()
{
	...
	if ((Instigator != None) && (Instigator.Controller != None))
	{
		if ((Instigator != None) && (Instigator.Controller != None))
		{
			...
			if (M1Inv.GlacialHuntActive || M2Inv.GlacialHuntActive || M3Inv.GlacialHuntActive)
			{
...
defaultproperties
{
     ...
     PickupClass=Class'DEKRPG208.ArtifactMissionGlacialHuntPickup'
     IconMaterial=Texture'MissionsTex4.HuntMissions.GlacialHuntMission'
