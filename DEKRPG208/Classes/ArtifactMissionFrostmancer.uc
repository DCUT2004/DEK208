class ArtifactMissionFrostmancer extends ArtifactMission
		config(UT2004RPG);
...
function Activate()
{
	...
	if ((Instigator != None) && (Instigator.Controller != None))
	{
		if ((Instigator != None) && (Instigator.Controller != None))
		{
			...
			if (M1Inv.FrostmancerActive || M2Inv.FrostmancerActive || M3Inv.FrostmancerActive)
			{
...
defaultproperties
{
     ...
     PickupClass=Class'DEKRPG208.ArtifactMissionFrostmancerPickup'
     IconMaterial=Texture'MissionsTex4.MagicWeaponMissions.FrostmancerMission'
