class CometGreen extends CometRed;
...
simulated function PostBeginPlay()
{
	...
	RealSmokeTrail = Spawn(class'CometGreenFX',self);
	RealCorona = Spawn(class'CometGreenCorona',self);
	if (RealCorona != None)
...
simulated function Explode(vector HitLocation, vector HitNormal)
{
    ...
    {
    	A = Spawn(class'CometGreenHitEffect',,,HitLocation + HitNormal*20,rotator(HitNormal));
		if (A != None)
...
defaultproperties
{
	 Skins(0)=FinalBlend'D-E-K-HoloGramFX.NonWireframe.FunkyStuff_2'
	 LightHue=75
}
