class MissionBalloonYellow extends MissionBalloon;
...
function TakeDamage(int Damage, Pawn instigatedBy, Vector hitlocation, Vector momentum, class<DamageType> damageType)
{
	...
	{
		class'MissionMultiplayerInv'.static.UpdateCounts(2);
	}

	A = spawn(class'MissionBalloonYellowPopEffect',,, Self.Location + vect(0,0,55));
	if (A != None)
	{
