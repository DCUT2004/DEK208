class AerialTrap extends Weapon
	config(DEKWeapons);

#exec OBJ LOAD FILE=HudContent.utx

var array<AerialTrapProjectile> Mines;
...
defaultproperties
{
     ...
     FireModeClass(0)=Class'DEKRPG208.AerialTrapFire'
     FireModeClass(1)=Class'DEKRPG208.AerialTrapAltFire'
     PutDownAnim="PutDown"
     ...
     bCanThrow=False
     Description="The Aerial Trap automatically detones when an enemy target comes into contact."
