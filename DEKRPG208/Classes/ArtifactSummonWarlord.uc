class ArtifactSummonWarlord extends RPGArtifact
	config(UT2004RPG);
...
{		
	...
	M = MInv.SummonMonster(class'SkaarjPack.Warlord', 50, 0);
...
defaultproperties
{
     ...
     PickupClass=Class'DEKRPG208.ArtifactSummonWarlordPickup'
