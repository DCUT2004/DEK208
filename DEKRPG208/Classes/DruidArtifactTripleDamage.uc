...
defaultproperties
{
     Invalid(0)=Class'DEKRPG208.RW_Rage'
     Invalid(1)=Class'DEKRPG208.RW_Vorpal'
     Invalid(2)=Class'DEKRPG208.RW_EngineerLink'
     CostPerSec=10
     PickupClass=Class'DEKRPG208.DruidArtifactTripleDamagePickup'
}
