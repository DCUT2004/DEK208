class DEKAutoMachinegun extends ASTurret;
...
{
	DefaultWeaponClassName=string(class'DEKAutoMachinegunWeapon');
...
{
	local DEKAutoMachinegunController C;
	
	C = DEKAutoMachinegunController(self.Controller);
