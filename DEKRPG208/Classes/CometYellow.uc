class CometYellow extends CometRed;
...
simulated function PostBeginPlay()
{
	...
	RealSmokeTrail = Spawn(class'CometYellowFX',self);
	RealCorona = Spawn(class'CometYellowCorona',self);
	if (RealCorona != None)
...
simulated function Explode(vector HitLocation, vector HitNormal)
{
    ...
    {
    	A = Spawn(class'CometYellowHitEffect',,,HitLocation + HitNormal*20,rotator(HitNormal));
		if (A != None)
