...
class IceGiantGasbag extends DCGiantGasbag;
...
function SpawnBelch()
{
	...
	{
		G = spawn(class 'IceChildGasbag',self,,FireStart + (0.6 * CollisionRadius + class'SMPGiantGasbag'.Default.CollisionRadius) * X);
		if ( G != None )
		{
			G.ParentBag = self;
			numChildren++;
...
defaultproperties
{
     ...
     Skins(0)=Shader'DEKMonstersTexturesMaster206E.IceMonsters.IceGasbagShader1'
     Skins(1)=Shader'DEKMonstersTexturesMaster206E.IceMonsters.IceGasbagShader2'
     Mass=180.000000
}
