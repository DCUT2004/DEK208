...
#exec OBJ LOAD FILE=DEKStaticsMaster207P.usx
...
simulated function PostBeginPlay()
{
	...
	if (decision < 0.34)
		...
		SetStaticMesh(staticmesh'DEKStaticsMaster207P.Meshes.CrystalA');
}
...
defaultproperties
{
     ...
     Damage=20.000000
     MyDamageType=Class'DEKMonsters208.DamTypeIceTitan'
