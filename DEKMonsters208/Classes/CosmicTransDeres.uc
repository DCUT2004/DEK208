class CosmicTransDeres extends Emitter;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter4
         ...
         ColorScale(1)=(RelativeTime=0.100000,Color=(B=97,G=9,R=130))
         ColorScale(2)=(RelativeTime=0.750000,Color=(B=97,G=9,R=130))
     ...
     End Object
     Emitters(0)=SpriteEmitter'DEKMonsters208.CosmicTransDeres.SpriteEmitter4'
