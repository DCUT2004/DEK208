class HalloweenShellGasbagPumpkinSeed extends Projectile;
...
simulated function PostBeginPlay()
{
    ...
    if ( Level.NetMode != NM_DedicatedServer )
    {
        ...
        {
            Trail = Spawn(class'HalloweenPumpkinSeedTrail',self);
...
{
    if ( (HalloweenShellGasbagPumpkinSeed(Other) == None) && ((Physics == PHYS_Falling) || (Other != Instigator)) )
    {
...
defaultproperties
{
     ...
     MyDamageType=Class'DEKMonsters208.DamTypeShellGasbag'
     DrawType=DT_StaticMesh
     StaticMesh=StaticMesh'PumpkinGunStat.Seed2'
     CullDistance=3000.000000
     LifeSpan=2.700000
     DrawScale=0.350000
     Skins(0)=Texture'PumpkinGunText.Seed'
     AmbientGlow=254
     Style=STY_Alpha
     bBounce=True
}
