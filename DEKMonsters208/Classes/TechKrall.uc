...
{	
	...
	local TechKrallWebLeader Leader;
	local TechKrallWeb P;
	...
	for(i=0; i<NumProjectiles; i++)
	{
		...
		if(i == 0)
		{
			Leader = spawn(class'TechKrallWebLeader', self, , projStart, rotator(FireDir));
		...
		{
			P = spawn(class'TechKrallWeb', self, , projStart, rotator(FireDir));
