...
function TakeDamage( int Damage, Pawn instigatedBy, Vector hitlocation, vector momentum, class<DamageType> damageType)
{
    ...
    local GiantRageBunnyCharger BunnyUltima;
	...
	DropPickups(Instigator.Controller, InstigatedBy.Controller, class'DEKRPG208.GemExperiencePickupGold', None, 3);
    
    BunnyUltima = spawn(class'GiantRageBunnyCharger',MC);
