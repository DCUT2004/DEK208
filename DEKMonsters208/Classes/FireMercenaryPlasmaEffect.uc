class FireMercenaryPlasmaEffect extends ONSRedPlasmaSmallFireEffect;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter37
         ...
         SpinParticles=True
         UniformSize=True
         ColorScale(0)=(Color=(B=38,G=200,R=255))
         ColorScale(1)=(RelativeTime=0.800000,Color=(B=38,G=200,R=255))
         ColorScale(2)=(RelativeTime=1.000000,Color=(B=38,G=200,R=255))
     ...
     End Object
     Emitters(0)=SpriteEmitter'DEKMonsters208.FireMercenaryPlasmaEffect.SpriteEmitter37'

     Begin Object Class=SpriteEmitter Name=SpriteEmitter38
         UseDirectionAs=PTDU_Right
         AutomaticInitialSpawning=False
         ColorScale(0)=(Color=(B=38,G=200,R=255))
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=38,G=200,R=255))
         CoordinateSystem=PTCS_Relative
         MaxParticles=1
         ...
         RelativeWarmupTime=2.000000
     End Object
     Emitters(1)=SpriteEmitter'DEKMonsters208.FireMercenaryPlasmaEffect.SpriteEmitter38'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter39
         ...
         ColorScale(1)=(RelativeTime=0.100000,Color=(B=38,G=200,R=255))
         ColorScale(2)=(RelativeTime=0.500000,Color=(B=38,G=200,R=255))
     ...
     End Object
     Emitters(2)=SpriteEmitter'DEKMonsters208.FireMercenaryPlasmaEffect.SpriteEmitter39'
