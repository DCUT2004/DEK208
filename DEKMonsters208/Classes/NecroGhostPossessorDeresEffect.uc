class NecroGhostPossessorDeresEffect extends Emitter;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter4
         ...
         ColorScale(1)=(RelativeTime=0.100000,Color=(B=57,G=204,R=24))
         ColorScale(2)=(RelativeTime=0.750000,Color=(B=57,G=204,R=24))
     ...
     End Object
     Emitters(0)=SpriteEmitter'DEKMonsters208.NecroGhostPossessorDeresEffect.SpriteEmitter4'
