class DCTitan extends SMPTitan;
...
function bool SameSpeciesAs(Pawn P)
{
	if (SummonedMonster)
		...
		return (  P.class == class'DCTitan' || P.class == class'DCStoneTitan' || P.class == class'DEKGoldTitan' || P.class == class'DEKGhostTitan' || P.class == class'CosmicTitan' || P.class == class'TechTitan' || P.Class == class'FireTitan' || P.Class == class'IceTitan' || P.Class == class'FruitCakeTitan' || P.Class == class'HalloweenTitan' );
}
...
defaultproperties
{
     AmmunitionClass=Class'DEKMonsters208.TitanAmmo'
