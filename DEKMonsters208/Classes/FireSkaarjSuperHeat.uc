...
class FireSkaarjSuperHeat extends DCFireSkaarj;
...
defaultproperties
{
     ...
     ScoringValue=14
     Health=375
     Skins(0)=Shader'DEKMonstersTexturesMaster206E.FireMonsters.FireSkaarjSuperHeatShader'
     Skins(1)=Shader'DEKMonstersTexturesMaster206E.FireMonsters.FireSkaarjSuperHeatShader'
