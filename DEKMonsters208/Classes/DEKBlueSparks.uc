class DEKBlueSparks extends xEmitter;

//     Skins(0)=Texture'Crosshairs.HUD.Crosshair_Circle1'      Skins(0)=Texture'DEKMonstersTexturesMaster206E.MonstersGhost.BloodPuffBlue'
...
defaultproperties
{
     ...
     mSizeRange(0)=4.500000
     mSizeRange(1)=1.500000
     mGrowthRate=-2.000000
     mColorRange(0)=(G=70,R=70)
     mColorRange(1)=(B=150,G=25,R=25)
     mAttenKa=0.000000
