...
class IceTentacle extends DCTentacle;
...
defaultproperties
{
     ...
     AmmunitionClass=Class'DEKMonsters208.IceTentacleAmmo'
     ScoringValue=2
     GibGroupClass=Class'DEKMonsters208.IceGibGroup'
     Health=87.5
     ControllerClass=Class'DEKMonsters208.DCMonsterController'
     Skins(0)=Shader'DEKMonstersTexturesMaster206E.IceMonsters.JtentacleIceShader'
     Skins(1)=Shader'DEKMonstersTexturesMaster206E.IceMonsters.JtentacleIceShader'
     Mass=180.000000
}
