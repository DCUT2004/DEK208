class IceBruteRocket extends BruteRocket;
...
defaultproperties
{
     ...
     MyDamageType=Class'DEKMonsters208.DamTypeIceBrute'
     ExplosionDecal=None
     LightHue=120
     StaticMesh=StaticMesh'DEKStaticsMaster207P.Meshes.IceRocketProj'
