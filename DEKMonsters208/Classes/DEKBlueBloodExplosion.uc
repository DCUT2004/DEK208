class DEKBlueBloodExplosion extends xEmitter;
...
defaultproperties
{
     ...
     mColorRange(0)=(G=180,R=180)
     mColorRange(1)=(G=210,R=210)
     Skins(0)=Texture'DEKMonstersTexturesMaster206E.GhostMonsters.BloodPuffBlue'
     Style=STY_Alpha
}
