class BlastKrallTrail extends Emitter;
...
defaultproperties
{
     ...
     End Object
     Emitters(0)=SpriteEmitter'DEKMonsters208.BlastKrallTrail.SpriteEmitter21'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter18
         ...
         ColorScale(1)=(RelativeTime=0.100000,Color=(G=255,R=55))
         ColorScale(2)=(RelativeTime=0.800000,Color=(G=255,R=55))
         ColorScale(3)=(RelativeTime=1.000000,Color=(G=255,R=55))
         CoordinateSystem=PTCS_Relative
         MaxParticles=6
     ...
     End Object
     Emitters(1)=SpriteEmitter'DEKMonsters208.BlastKrallTrail.SpriteEmitter18'
