...
class FireRazorFly extends DCRazorFly;
...
defaultproperties
{
     ...
     Skins(0)=Shader'DEKMonstersTexturesMaster206E.FireMonsters.FireRazorFlyShader'
     Skins(1)=Shader'DEKMonstersTexturesMaster206E.FireMonsters.FireRazorFlyShader'
}
