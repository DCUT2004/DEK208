class IceWarlordRocket extends Projectile;

var	IceKrallTrailSmoke SmokeTrailE;
// camera shakes //
...
simulated function PostBeginPlay()
{
	...
	{
		SmokeTrailE = Spawn(class'IceKrallTrailSmoke',self,,Location - 40 * Dir, Rotation);
...
defaultproperties
{
     ...
     ExplosionEffectClass=Class'DEKMonsters208.IceWarlordRocketExplosion'
     Team=255
     Speed=1000.000000
     ...
     MyDamageType=Class'DEKMonsters208.DamTypeIceWarlord'
     LightType=LT_Steady
