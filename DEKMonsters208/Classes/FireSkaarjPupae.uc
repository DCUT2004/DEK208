...
class FireSkaarjPupae extends DCPupae;
...
defaultproperties
{
     ...
     Skins(0)=Shader'DEKMonstersTexturesMaster206E.FireMonsters.FireSkaarjPupaeShader'
     Skins(1)=Shader'DEKMonstersTexturesMaster206E.FireMonsters.FireSkaarjPupaeShader'
}
